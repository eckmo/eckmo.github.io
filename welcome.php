...
<head>
    ...
    <meta name="description" content="H2Open App page for CS 361">
...
<body data-spy="scroll" data-target="#primary-menu">
        ...
        <div class="container">
            <div class="row v-center">
              ...
              <div class="col-md-5 text-right" id="gifdiv">
                  <img src="https://i.imgur.com/19o7SpQ.gif" id="gif" alt="waterfall">
              </div>
            </div>
          </div>
        ...
        <div class="container">
            ...
            <div class="row">
              <div class="container-fluid" id="mapdiv">
                <img src="https://i.imgur.com/BcM9oXY.jpg" id="map" alt="Fake map">
              </div>
            </div>
        </div>
    </section>
    ...
    <section class="gray-bg section-padding" id="faq-page">
        <div class="container">
            ...
            <div class="row">
              <div class="container-fluid" id="anayticsdiv">
                  <img src="https://i.imgur.com/Bn0oOZY.png" id="analyticsz" alt="Fake analytics">
              </div>
            </div>
        </div>
    </section>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-xs-12 col-sm-6 col-sm-offset-3 text-center">
                        <div class="page-title">
                            <h2>Get in touch</h2>
                            <p>Have question or comments about H2Open or just want to say hi? Let us know!</p>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-xs-12 col-md-4">
                        <address class="side-icon-boxes">
                            <div class="side-icon-box">
                                ...
                                <p><strong>Address: </strong> Corvallis, OR 97331 <br />USA</p>
                            </div>
                            <div class="side-icon-box">
                                <div class="side-icon">
                                ...
                                <p><strong>Telephone: </strong>
                                    <a href="callto:8801812726495">+877.257.5182</a> <br />
                                    <a href="callto:8801687420471">+541.737.1805</a>
                                </p>
                            </div>
                            <div class="side-icon-box">
                                <div class="side-icon">
                                ...
                                <p><strong>E-mail: </strong>
                                    <a href="mailto:hello@h2open.com">hello@h2open.com</a> <br />
                                </p>
                            </div>
                        </address>
                    </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-xs-12 text-center">
                        <p>&copy;Copyright 2019 All rights reserved.<i class="ti-heart" aria-hidden="true"></i> by <a href="https://colorlib.com">Colorlib</a></p>
                    </div>
                </div>
            </div>
        </div>
